...
/// <summary>
/// Represents the session that retrieves the latest migration info for EntityFramework.
/// </summary>
...
public class EntityFrameworkGetLatestMigrationInfoSession<TDbContext, TMigrationInfo> : AsyncReadOnlySession<TDbContext>, IGetLatestMigrationInfoSession<TMigrationInfo>
    where TDbContext : DbContext, IHasMigrationInfos<TMigrationInfo>
    where TMigrationInfo : BaseMigrationInfo
{
    /// <summary>
    /// Initializes a new instance of <see cref="EntityFrameworkGetLatestMigrationInfoSession{TDbContext, TMigrationInfo}" />.
    /// </summary>
    ...
    public EntityFrameworkGetLatestMigrationInfoSession(TDbContext dbContext) : base(dbContext) { }
...
/// </summary>
public sealed class EntityFrameworkGetLatestMigrationInfoSession<TDbContext> : EntityFrameworkGetLatestMigrationInfoSession<TDbContext, MigrationInfo>
